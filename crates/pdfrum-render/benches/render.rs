...
//!
//! ```text
//! render-cold-exact       render-warm-exact
...
fn cold_exact(c: &mut Criterion) {
    cold(c, "render-cold-exact", Backend::Exact);
}
...
fn warm_exact(c: &mut Criterion) {
    warm(c, "render-warm-exact", Backend::Exact);
}
...
mod group {
    use super::{
        Criterion, Duration, cold_exact, cold_tinyskia, cold_vello, warm_exact, warm_tinyskia,
        warm_vello,
    };
    ...
    criterion_group! {
        ...
        config = Criterion::default()
            ...
            .sample_size(50);
        targets = cold_exact, cold_tinyskia, cold_vello, warm_exact, warm_tinyskia, warm_vello
    }
}
