...
pub(crate) use pdfrum_object::names::{
    ...
    PAGES, PARENT, PREV, PROPERTIES, Q, QUAD_POINTS, R, RECT, RESOURCES, ROOT, ROTATE, S, SIZE,
    SMASK, STANDARD, STEM_V, SUBJECT, SUBTYPE, T, TITLE, TO_UNICODE, TRIM_BOX, TRUE_TYPE, TYPE,
    TYPE1, VIEWER_PREFERENCES, W, WIDTH, WIDTHS, WIN_ANSI_ENCODING, XML, XOBJECT, XREF, XREF_STM,
};
